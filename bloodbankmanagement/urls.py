...
urlpatterns = [
    ...
    path('whydonate',views.whydonate, name="whydonate"),
    ...
    path('delete-camp/<int:pk>', views.delete_camp_view, name="delete-camp"),
    path('edit-camp-details/<int:pk>', views.edit_camp_details, name="edit-camp-details"),
